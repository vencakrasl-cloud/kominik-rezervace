...
const GOOGLE_SHEETS_URL = 'https://script.google.com/macros/s/AKfycbw9pshqgVLAIqOJvKWCqKAdR6V4qEJnlUjEmZQbTD-556GqC8n4O76liVCF5T8WnAca/exec';
...
const KominikReservation = () => {
  ...
  // Načtení rezervací z Google Calendar přes Web App
