...
const KominikReservation = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!result.success) {
        // Chyba - termín je obsazený nebo jiná chyba
        alert(result.error || 'Nepodařilo se vytvořit rezervaci. Zkuste jiný termín.');
        setSubmitting(false);
        return;
      }
      
      // Úspěch - přidej do lokálního stavu (pro okamžité blokování)
